  ...
  data: {
    ...
    population: {
      ...
      description_population: {
        age: "공릉 1동은 20~40대가 전체의 67%를 차지해 젊은 소비층 중심의 상권 형성이 뚜렷해요. 50대 이상은 25% 수준으로, 고연령층보다는 청장년층을 대상으로 한 소비 전략이 효과적일 가능성이 커요.",
        gender:
    ...
    price: {
      ...
      small: {
        small_average: 60310000,
        small_middle: 60310000,
        small_count: 50,
      },
